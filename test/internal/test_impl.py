...
def test_board_is_valid_empty(alphabet):
    board = BoardImpl(2, 2, alphabet)

    assert board.is_valid()
    assert not board.is_final()


def test_board_is_valid_patrially_empty_valid(alphabet):
    board = BoardImpl(2, 2, alphabet)
...
# def test_board_is_valid_partially_empty_invalid(alphabet):
#     board = BoardImpl(2, 2, alphabet)
# 
#     board[0, 0] = '2'
#     board[0, 1] = '1'
...
def test_board_is_valid_no_empty_valid(alphabet):
    board = BoardImpl(2, 2, alphabet)
...
# def test_board_is_valid_no_empty_invalid(alphabet):
#     board = BoardImpl(2, 2, alphabet)
# 
#     board[0, 0] = '2'
#     board[0, 1] = '1'
...
def test_board_is_full_empty(alphabet):
    board = BoardImpl(2, 2, alphabet)

    assert not board.is_full()
    assert not board.is_final()

def test_board_is_full_partially_empty(alphabet):
    board = BoardImpl(2, 2, alphabet)
...
def test_board_is_full_full(alphabet):
    board = BoardImpl(2, 2, alphabet)
